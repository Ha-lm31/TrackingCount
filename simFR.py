...
#Dans x changer entre 'down' et 'up'
#Dans y changer entre 'right' et 'left'
x = {'right':[0,0,0], 'left':[1400,1400,1400], 'down':[602,627,657], 'up':[755,727,697]}    
y = {'right':[498,466,436], 'left':[348,370,398], 'down':[0,0,0], 'up':[800,800,800]}
...
#On met la derniere coordonnées au début : r -> u -> l -> d
...
#Changer entre 'right' et 'left' et entre 'up' et 'down'
mid = {'right': {'x':695, 'y':425}, 
       'left': {'x':705, 'y':445},
       'down': {'x':695, 'y':400},
       'up': {'x':695, 'y':450}}
